                            ...
                            r#"<div class="col-lg-6 col-xl-5 offset-xl-1 cart-summary-section">"#,
                                ...
                                buf.push_str(r#"<div class="col-lg-5 offset-lg-1 col-xl-4">"#);
                                {
                                    buf.push_str(r#"<form class="cart-checkout-form" action="/cart/checkout" method="POST">"#);
                                    {
                                        ...
                                        {
                                            buf.push_str(
                                                r#"<div class="col-md-5 cymbal-form-field">"#,
                                            );
                                            {
                                            ...
                                            buf.push_str(
                                                r#"<div class="col-md-7 cymbal-form-field">"#,
                                            );
                                            {
                                                buf.push_str(
                                                    r#"<label for="country">Country</label>"#,
                                                );
                                        ...
                                        buf.push_str(r#"<div class="form-row">"#);
                                        {
                                            ...
                                            r#"<label for="credit_card_expiration_month">Month</label>"#,
                                                ...
                                                buf.push_str(r#"<select name="credit_card_expiration_month" id="credit_card_expiration_month">"#);
                                                {
                                                    ...
                                                    buf.push_str(
                                                        r#"<option value="3">March</option>"#,
                                                    );
                                                    buf.push_str(
                                                        r#"<option value="4">April</option>"#,
                                                    );
                                                    buf.push_str(
                                                        r#"<option value="5">May</option>"#,
                                                    );
                                                    buf.push_str(
                                                        r#"<option value="6">June</option>"#,
                                                    );
                                                    buf.push_str(
                                                        r#"<option value="7">July</option>"#,
                                                    );
                                                    buf.push_str(
                                            ...
                                            buf.push_str(
                                                r#"<div class="col-md-4 cymbal-form-field">"#,
                                            );
                                            {
                                                buf.push_str(
                                            ...
                                            buf.push_str(
                                                r#"<div class="col-md-3 cymbal-form-field">"#,
                                            );
                                            {
                                                buf.push_str(
