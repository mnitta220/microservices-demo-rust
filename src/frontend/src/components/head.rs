...
pub fn write(buf: &mut String) -> Result<(), &'static str> {
    buf.push_str(r#"<head>"#);
    {
        ...
        buf.push_str(r#"<link href="https://fonts.googleapis.com/css2?family=DM+Sans:ital,wght@0,400;0,700;1,400;1,700&display=swap" "#);
        buf.push_str(r#"rel="stylesheet">"#);
        buf.push_str(r#"<link rel="stylesheet" type="text/css" href="/static/styles/styles.css">"#);
        buf.push_str(r#"<link rel="stylesheet" type="text/css" href="/static/styles/cart.css">"#);
        buf.push_str(r#"<link rel="stylesheet" type="text/css" href="/static/styles/order.css">"#);
        buf.push_str(r#"<link rel="icon" type="image/x-icon" href="/static/favicon.ico">"#);
    }
    buf.push_str(r#"</head>"#);
