...
impl BodyMain {
    pub async fn write(
        ...
        match page_props.page_type {
            super::super::PageType::Home => self.write_home(buf, page_props).await,
            super::super::PageType::Product => self.write_product(buf, page_props).await,
        }
    }
                                ...
                                buf.push_str(r#"<div class="row">"#);
                                {
                                    buf.push_str(r#"<div class="col-md-3">"#);
                                    {
                                        buf.push_str(r#"<div>"#);
                                        {
                                            ...
                                            {
                                                buf.push_str(r#"<img alt src="/static/img/products/mug.jpg">"#);
                                            }
                                            buf.push_str(r#"</a>"#);
                                            buf.push_str(r#"<div>"#);
                                            {
